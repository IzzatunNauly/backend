            ...
            <form method="post" action="{{ route('kategori.store') }}" id="myForm">
                ...
                <div class="row">
                    <div class="col-md-10">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" name="nama_kategori" class="form-control" id="nama_kategori" aria-describedby="nama_kategori" style="width: 550px; background-color: #F0F8FF;">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-6 offset-md-4">
                        <button type="submit" class="btn btn-primary" style="margin-left: 365px; margin-top: 10px; background-color: #1d83b3; border-color: #000000; padding: 5px 50px; border-width: 2px; font-size: 15px;">Save</button>
                    </div>
                </div>
            </br>
            </form>
